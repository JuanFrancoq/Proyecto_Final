...
public class EmpleadoViewController {
    ...
    @FXML
    private TableColumn<Transaccion, String> tbc_Fecha;
    @FXML
    private TableColumn<Transaccion, String> tbc_Tipo;
    @FXML
    private TableColumn<Transaccion, String> tbc_Vehiculo;
    @FXML
    private TableColumn<Transaccion, String> tbc_Cliente;
    @FXML
    private TableColumn<Transaccion, Double> tbc_Monto;
    ...
    private void initDataBinding() {
        ...
        btn_Alquilar.setOnAction(event -> abrirVentanaAlquilar());
        btn_Comprar.setOnAction(event -> abrirVentanaComprar());
        btn_Vender.setOnAction(event -> abrirVentanaVender());
    }
    private void abrirVentanaAlquilar() {
        abrirVentanaTransaccion("Alquiler");
    }

    private void abrirVentanaVender() {
        abrirVentanaTransaccion("Venta");
    }

    private void abrirVentanaComprar() {
        abrirVentanaTransaccion("Compra");
    }
    private void abrirVentanaTransaccion(String tipo) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/edu/uniquindio/poo/view/TransaccionView.fxml"));
            AnchorPane pane = loader.load();
            TransaccionController controller = loader.getController();
            controller.setTipoTransaccion(tipo);
            controller.setParentController(this);

            Stage stage = new Stage();
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.setScene(new Scene(pane));
            stage.setTitle(tipo + " de Vehículo");
            stage.showAndWait();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void agregarTransaccion(Transaccion transaccion) {
        tblTransacciones.getItems().add(transaccion);
    }
