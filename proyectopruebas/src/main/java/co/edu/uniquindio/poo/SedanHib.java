...
public class SedanHib extends VehiculoHib {
    ...
    /**
     * Metodo constructor de Sedanhib
     * @param marca
     * @param modelo
     * @param tipoVehiculo
     * @param placa
    ...
    public SedanHib(String marca, String modelo, String tipoVehiculo, String placa, boolean nuevo, boolean revisionTecnica,
            ...
            co.edu.uniquindio.poo.TipoTransmision tipoTransmision, boolean enchufable,
            co.edu.uniquindio.poo.TipoCombustible tipoCombustible, int numPasajeros, int numPuertas,
